        ...
        <div class="card-body bg-ciu-light">
            ...
            <div class="row">
                <div class="col text-center">
                    <a href="{{ route('showInternal') }}" class="btn btn-secondary btn-lg">INTERNAS</a>
                </div>
                <div class="col text-center">
                    <img src="{{ asset('images/ciu_logo.png') }}" alt="Logo CIU">
                </div>
                <div class="col text-center">
                    <a href="{{ route('showExternal') }}" class="btn btn-ciu btn-lg">EXTERNAS</a>
                </div>
            </div>
